...
if(isset($_POST["query"]))
{
	...
	$search= $_POST["query"];
		...
		$query = "SELECT * FROM accessories where asName LIKE '%".$search."%'";
		}
...
if($total_row > 0)
{
 ...
 foreach($result as $row)
 {
  ...
  <tr>
   ...
   <td>'.$row["jaDesc"].'</td>
   <td>'.$row["jaPrice"].'</td>
   <td><img style="width: 100px" src="http://'.$row["jaImg"].'"></td>
 ...
 foreach($result as $row)
 {
  ...
  <tr>
   ...
   <td>'.$row["shrtDesc"].'</td>
   <td>'.$row["shrtPrice"].'</td>
   <td><img style="width:100px" src="http://'.$row["shrtImg"].'"></td>
 ...
 foreach($result as $row)
 {
  ...
  <tr>
   ...
   <td>'.$row["shDesc"].'</td>
   <td>'.$row["shPrice"].'</td>
   <td><img style="width:100px" src="http://'.$row["shImg"].'"></td>
 ...
 foreach($result as $row)
 {
  ...
  <tr>
   ...
   <td>'.$row["paDesc"].'</td>
   <td>'.$row["paPrice"].'</td>
   <td><img style="width:100px" src="http://'.$row["paImg"].'"></td>
 ...
 foreach($result as $row)
 {
  ...
  <tr>
   ...
   <td>'.$row["asDesc"].'</td>
   <td>'.$row["asPrice"].'</td>
   <td><img style="width:100px" src="http://'.$row["asImg"].'"></td>
